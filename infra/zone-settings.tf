...
# solo del subdominio de la demostración. Cambiar cualquiera de estos afecta
# también al sitio personal alojado en el mismo dominio.
#
...
# Sin esto, una primera petición en HTTP plano se sirve tal cual. El Worker
...
# análisis externo. 1.2 deja fuera clientes anteriores a 2013, irrelevantes
# para el publico de esta demostración.
